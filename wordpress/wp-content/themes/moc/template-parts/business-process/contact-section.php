<section class="moc-section moc-contact-section contact-form-wrapper wide-form-wrapper" id="estimate-project-form-c">
    ...
    <div class="moc-inner gform_wrapper" id="bpapage-form">
        <?php echo do_shortcode('[contact-form-7 id="24121" title="BPA Page Form"]'); ?>
    </div>
</section>